...
export function MapInfo({ map, inBasket, isPurchased = false, updateBasket }: MapInfoProps) {
  ...
  // Show MapInfo when scrolled down past 100px, hide when back at top
  ...
  return (
    <motion.div
      ...
      className='rounded-2xl border border-border bg-background/95 backdrop-blur-md shadow-xl p-6 md:p-8'
    >
